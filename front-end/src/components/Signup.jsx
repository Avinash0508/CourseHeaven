...
function Signup() {
  ...
  const [firstName/* this variable stores what function receives*/ ,setFirstName/* this function receives data from form*/]=useState("")
  ...
  const handleSubmit=async (e)=>{
    e.preventDefault();//it helps to not refresh the website
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                id="firstname"
                value={firstName}
                onChange={(e)=>setFirstName(e.target.value)}//this set the function that what will be typed in that input is its value
